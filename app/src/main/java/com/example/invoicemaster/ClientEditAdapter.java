...
public class ClientEditAdapter extends RecyclerView.Adapter<ClientEditAdapter.ClientViewHolder> {
    ...
    public ClientEditAdapter(List<Client> clients, OnItemClickListener listener) {
    ...
    class ClientViewHolder extends RecyclerView.ViewHolder {
        ...
        private void showPopupMenu(View view, int position) {
            ...
            popup.inflate(R.menu.clientedit);
            popup.setOnMenuItemClickListener(item -> {
                if (item.getItemId() == R.id.edit_option) {
                    if (listener != null) {
                        listener.onEditClicked(clients.get(position)); // Notify listener
                        return true;
                    }
                }
                return false;
